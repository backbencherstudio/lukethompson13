...
import 'package:lukethompson/presentation/reports/providers/tax_report_filter.dart';
...
class WeeklySummaryReport extends ConsumerWidget {
  ...
  static Future<void> refreshRepostPageData(WidgetRef ref) async {
    ref.invalidate(getWeeklyReportSummaryQuery);
    final filter = ref.read(taxReportFilterProvider);
    ref.invalidate(
