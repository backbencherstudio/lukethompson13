...
class _AuthApi implements AuthApi {
  ...
  @override
  Future<BaseResponse> register(RegisterRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> deleteAccount(DeleteAccountRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> verifyUserEmailAddress(VerifyEmailRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<GetMeResponse> updateUserProfile(
    ...
    if (freeWaitTime != null) {
      _data.fields.add(MapEntry('free_wait_time', freeWaitTime.toString()));
    }
    if (ratePerHour != null) {
      _data.fields.add(MapEntry('rate_per_hour', ratePerHour.toString()));
    }
    if (image != null) {
      _data.files.add(
        MapEntry(
  ...
  @override
  Future<BaseResponse> forgotPassword(ForgotPasswordRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> checkOtp(CheckOtpRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> resetForgottenPassword(ResetPasswordRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
